...
from fugu.backends import snn_Backend  # , pynn_Backend, ds_Backend
...
class RegisterBrickTests(BrickTest):
    ...
    def build_scaffold(self, input_values):
        ...
        recall_brick = BRICKS.Vector_Input(converted_input['recall'], coding='Raster', name='Recall', time_dimension=True)
