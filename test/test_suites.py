...
from test_core import SnnCoreTests, DsCoreTests, PynnBrianCoreTests, PynnSpinnakerCoreTests

loader = unittest.TestLoader()

snn_suite = unittest.TestSuite()
snn_suite.addTest(loader.loadTestsFromTestCase(SnnCoreTests))
...
ds_suite.addTest(loader.loadTestsFromTestCase(DsCoreTests))
...
pynn_brian_suite.addTest(loader.loadTestsFromTestCase(PynnBrianCoreTests))
...
pynn_spinnaker_suite.addTest(loader.loadTestsFromTestCase(PynnSpinnakerCoreTests))
