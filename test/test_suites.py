...
from test_test_bricks.test_instant_decay import SnnInstantDecayTests
from test_test_bricks.test_synapse_properties import SnnThresholdTests
...
from test_utility_bricks.test_temporal_adder_brick import SnnTemporalAdderTests #, DsTemporalAdderTests
# from .test_utility_bricks import PynnSpinnakerTemporalAdderTests, PynnBrianTemporalAdderTests
from test_register_bricks.test_addition_brick import SnnAdditionTests #, DsAdditionTests
# from .test_register_bricks import PynnSpinnakerAdditionTests, PynnBrianAdditionTests
from test_register_bricks.test_subtraction_brick import SnnSubtractionTests #, DsSubtractionTests
# from .test_register_bricks import PynnSpinnakerSubtractionTests, PynnBrianSubtractionTests
from test_register_bricks.test_register_brick import SnnRegisterTests #, DsRegisterTests
# from .test_register_bricks import PynnSpinnakerRegisterTests, PynnBrianRegisterTests
from test_register_bricks.test_max_brick import SnnMaxTests #, DsMaxTests
# from .test_register_bricks import PynnSpinnakerMaxTests, PynnBrianMaxTests
from test_app_bricks.test_lis_brick import SnnLISTests #, DsLISTests
# from .test_app_bricks import PynnSpinnakerLISTests, PynnBrianLISTests
from test_stochastic_bricks.test_threshold_brick import SnnThresholdTests #, DsThresholdTests
from test_graph_bricks.test_simple_graph_traversal_brick import SnnSimpleGraphTraversalTests #, DsSimpleGraphTraversalTests
# from .test_graph_bricks import PynnSpinnakerSimpleGraphTraversalTests, PynnBrianSimpleGraphTraversalTests
from test_graph_bricks.test_register_graph_traversal_brick import SnnRegisterGraphTraversalTests #, DsRegisterGraphTraversalTests
...
# pynn_spinnaker_suite.addTest(loader.loadTestsFromTestCase(PynnSpinnakerAdditionTests))
...
# pynn_brian_suite.addTest(loader.loadTestsFromTestCase(PynnBrianTemporalAdderTests))
