...
class loihi_Backend(Backend):
    ...
    def _build_network(self):
        ...
        # Analyze connections. Determine best delay buffer depth.
        delayBuffer = 8
        avgDelay = 0
        ...
        * This is sufficient for summing any amount of weight, since threshold should not exceed (-1,1).
        ...
        for n, node in G.nodes.data():
            ...
            if P == 1:  # Deterministic firing
                ...
                # Poisson spike generator. The threshold is determined by the spike probability.
        ...
        delayCompProto = nx.CompartmentPrototype(vThMant                  = 100,
                                                 numDendriticAccumulators = delayBuffer)
