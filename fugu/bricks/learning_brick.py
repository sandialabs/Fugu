...
class Learner(Brick):
    """
    Base class for learner bricks.
    Learner bricks are used to learn from data and update their parameters accordingly.
    """
    ...
    def __init__(self, name=None):
        ...
        self.metadata = {'isLearner': True, 'name': name}

    def build(self, graph, metadata, control_nodes, input_lists, input_codings):
        """
        Build the learner brick.
        ...
        """
        raise NotImplementedError("Learner build method must be implemented in subclasses.")
