# Utility classes to parse tab- or comma-separated-value files which have incremental column headers
# and sparse row data. This is general enough to parse regular TSV or CSV files as well.
# Copied here from the N2A Python runtime for convenience.
