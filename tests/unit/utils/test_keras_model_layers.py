...
class Test_Keras_Conv2d:
    def test_simple_conv2d(self):
        ...
        input_shape = (2,2,1)
        init_kernel = np.reshape(np.arange(1,5),(2,2,1,1))
        ...
        model = Sequential()
        model.add(inputs)
        model.add(Conv2D(1, (2, 2), padding='same', activation=None, use_bias=True, name="one", kernel_initializer=kernel_initializer, bias_initializer=bias_initializer))
    ...
    def test_simple_same_mode_conv2d_strides_2x2_image(self, strides, expected):
        ...
        *** IMPORTANT ***
        ...
        model = Sequential()
        model.add(inputs)
        model.add(Conv2D(1, (2, 2), strides=strides, padding='same', activation=None, use_bias=True, name="one", kernel_initializer=kernel_initializer, bias_initializer=bias_initializer))
        # feature_extractor = Model(inputs=model.inputs, outputs=model.get_layer(name="one").output)
        feature_extractor = Model(inputs=inputs, outputs=[layer.output for layer in model.layers])
    ...
    def test_simple_valid_mode_conv2d_strides_3x3_image(self):
        ...
        model11 = Sequential()
        model11.add(inputs)
        model11.add(Conv2D(1, (2, 2), strides=(1,1), padding='valid', activation=None, use_bias=True, name="one", kernel_initializer=kernel_initializer, bias_initializer=bias_initializer))
        feature_extractor11 = Model(inputs=inputs, outputs=model11.get_layer(name="one").output)
        ...
        model12 = Sequential()
        model12.add(inputs)
        model12.add(Conv2D(1, (2, 2), strides=(1,2), padding='valid', activation=None, use_bias=True, name="one", kernel_initializer=kernel_initializer, bias_initializer=bias_initializer))
        feature_extractor12 = Model(inputs=inputs, outputs=model12.get_layer(name="one").output)
        ...
        model21 = Sequential()
        model21.add(inputs)
        model21.add(Conv2D(1, (2, 2), strides=(2,1), padding='valid', activation=None, use_bias=True, name="one", kernel_initializer=kernel_initializer, bias_initializer=bias_initializer))
        feature_extractor21 = Model(inputs=inputs, outputs=model21.get_layer(name="one").output)
        ...
        model22 = Sequential()
        model22.add(inputs)
        model22.add(Conv2D(1, (2, 2), strides=(2,2), padding='valid', activation=None, use_bias=True, name="one", kernel_initializer=kernel_initializer, bias_initializer=bias_initializer))
        feature_extractor22 = Model(inputs=inputs, outputs=model22.get_layer(name="one").output)
    ...
    def test_simple_multichannel_conv2d(self):
        ...
        # init_kernel = np.moveaxis(np.arange(1,9).reshape(2,2,nChannels,1),1,3)
        # init_kernel = np.arange(1,9).reshape(2,2,nChannels,1)
        init_kernel = generate_keras_kernel(2,2,1,nChannels)
        init_bias = np.zeros((1,))
        ...
        model = Sequential()
        model.add(inputs)
        model.add(Conv2D(1, (2, 2), strides=strides, padding=mode, activation=None, use_bias=True, name="one", kernel_initializer=kernel_initializer, bias_initializer=bias_initializer))
        ...
        expected = keras_convolve2d_4dinput(mock_image,init_kernel,strides=strides,mode=mode,filters=1).tolist()
        assert expected == calculated
    ...
    def test_multifilter_conv2d(self):
        ...
        model = Sequential()
        model.add(inputs)
        model.add(Conv2D(nFilters, (2, 2), strides=strides, padding=mode, activation=None, use_bias=True, name="one", kernel_initializer=kernel_initializer, bias_initializer=bias_initializer))
    ...
    def test_explicit_multifilter_multichannel_conv2d(self):
        ...
        model = Sequential()
        model.add(inputs)
        model.add(Conv2D(nFilters, (kernel_height, kernel_width), strides=strides, padding=mode, activation=None, use_bias=True, name="one", kernel_initializer=kernel_initializer, bias_initializer=bias_initializer))
...
class Test_Keras_Multilayer_Model:
    ...
    def test_simple_multilayer_model(self, mock_conv2d_output, pool_size, pool_strides, expected):
        ...
        model = Sequential()
        model.add(inputs)
        model.add(Conv2D(1, (2, 2), strides=(1,1), padding='same', activation=None, use_bias=True, name="one", kernel_initializer=kernel_initializer, bias_initializer=bias_initializer))
        model.add(MaxPooling2D(pool_size=pool_size, strides=pool_strides, padding='same', name="two"))
