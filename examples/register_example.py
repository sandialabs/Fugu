...
#result = scaffold.evaluate(backend=backend, max_runtime=MAX_RUNTIME, record_all=True, backend_args=pynn_args)
result = scaffold.evaluate(backend=backend, max_runtime=MAX_RUNTIME, backend_args=pynn_args, record_all=True)
